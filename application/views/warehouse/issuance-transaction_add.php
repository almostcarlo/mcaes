                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="x_panel tile">
                                <div class="x_title">
                                    <h2>Issuance - Add Form</h2>
                                    <ul class="nav navbar-right panel_toolbox">
                                        <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></li>
                                        <li><a class="close-link"><i class="fa fa-close"></i></a></li>
                                    </ul>
                                    <!--<a href=""  class="btn btn-success pull-right"><i class="fa fa-print"></i> Print</a>
                                    <a href="issuance-transaction_add.php" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Add New</a>-->
                                ...
                                <div class="x_content">
                                    ...
                                    <form action="" method="post">
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <label for="inputWorkersName">Issuance No.:</label>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label for="inputTransactionDate">Issuance Date:</label>
                                            ...
                                            <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label for="selectClinic">Request Type:</label>
                                                        <select class="form-control" id="selectClinic" name="clinid">
                                                            <option>please select</option>
                                                            <option value="">w/o request</option>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label for="selectClinic">Request Dept:</label>
                                                        <select class="form-control" id="selectClinic" name="clinid">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="inputTransactionNum">Requested by:</label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="selectUnit" name="clinid"> 
             ...
             <a href="#" class="btn btn-sm btn-danger btn-action" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash"></i></a>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 col-sm-3">
                                                <a href="<?php echo BASE_URL."index.php/warehouse/forms/issuance-transaction.php";?>" class="btn btn-default btn-block"><i class="fa fa-chevron-left"></i>   Exit</a>
                                            </div>
