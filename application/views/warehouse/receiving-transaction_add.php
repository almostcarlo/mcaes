                        ...
                        <div class="col-md-12">
                            <div class="x_panel tile">
                                ...
                                <div class="x_content">
                                    ...
                                    <form action="../../parts/insurance_entries_save.php" method="post">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" id="inputWorkersName" readonly placeholder="" value="" />
             ...
             <a href="#" class="btn btn-sm btn-danger btn-action" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash"></i></a>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 col-sm-3">
                                                <a href="<?php echo BASE_URL."index.php/warehouse/forms/receiving-transaction.php";?>" class="btn btn-default btn-block"><i class="fa fa-chevron-left"></i>   Exit</a>
                                            </div>
