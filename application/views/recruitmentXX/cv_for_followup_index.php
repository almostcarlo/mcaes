                    ...
                    <table class="table table-striped table-condensed table-hover mb-none" id="datatable_forsending">
                        <thead>
                            <tr>
                                ...
                                <td width="10%" class="text-center"><strong>Date Sent</strong></td>
...
?>
                                    <tr>
                                        ...
                                        <td class="text-center"><?php echo dateformat($v['sent_date'],1);?></td>
                                        <td class="text-center"><?php echo getDateDiff($v['sent_date'], "day");?></td>
                                    </tr>
<?php
                                    $n++;
                                }
