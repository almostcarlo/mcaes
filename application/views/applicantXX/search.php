...
<section role="main" class="content-body">
	...
	<?php echo form_open('applicant/search', 'id="frm_search_applicant"');?>
                            ...
                            <table class="table table-striped table-condensed table-hover mb-none" id="datatable_SearchApplicant">
                                ...
                                <tbody>
                                    <?php foreach ($applicants as $info):?>
                                        <tr>
                                            <td><a href="<?php echo BASE_URL;?>profile/<?php echo $info['id'];?>"><?php echo strtoupper(nameformat($info['fname'], $info['mname'], $info['lname'],1));?></a></td>
                                            ...
                                            <td class="actions text-center">
                                                ...
                                                <a href="<?php echo BASE_URL;?>pqd/default/<?php echo $info['id'];?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Print PQD" target="_blank"><i class="fa fa-print"></i></a>
