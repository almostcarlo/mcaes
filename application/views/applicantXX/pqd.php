            ...
            <table class="table table-bordered" cellspacing="0" style="margin-bottom: 10px;">
        		...
        		<tbody>
                    ...
                    <?php if($applicant_data['assessment']):?>
                    	<?php foreach ($applicant_data['assessment'] as $assessment_info):?>
                            <tr>
                            	<td><?php echo nl2br($assessment_info['details'])?></td>
                            	<td align="center"><?php echo $assessment_info['position']?></td>
                            	<td align="center"><?php echo $assessment_info['add_by']?></td>
                            	<td align="center"><?php echo dateformat($assessment_info['add_date'],3)?></td>
                            </tr>
                    	<?php endforeach;?>
                    <?php endif;?>
        		</tbody>
