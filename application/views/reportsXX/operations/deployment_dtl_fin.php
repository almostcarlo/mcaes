<?php
    if($excel){
        ...
        header("Content-Disposition: attachment; filename=deployment_dtl_fin.xls");
...
?>
<h3>Deployment Report - Finished Contract</h3>
...
?>
        <table class="table table-bordered" cellspacing="0" style="margin-bottom: 10px;" width="50%" border="1">
            <tbody>
                ...
                <tr>
                    <td width="17%" class="text-left"><strong>Name</strong></td>
                    <td width="21%" class="text-left"><strong>Principal</strong></td>
                    <td width="17%" class="text-left"><strong>Position</strong></td>
                    <td width="10%" class="text-center"><strong>Deployment Date</strong></td>
                    <td width="15%" class="text-center"><strong>Country</strong></td>
                    <td width="10%" class="text-center"><strong>Contract Duration</strong></td>
                    <td width="10%" class="text-center"><strong>Contract End</strong></td>
                ...
                ?>
                	<tr>
                		...
                		<td class="text-center"><?php echo strtoupper($info['contract_period']);?></td>
                        <td class="text-center"><?php echo dateformat($info['contract_fin_date'],0);?></td>
                	</tr>
                <?php
                    }
                ?>
