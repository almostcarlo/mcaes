<?php
    if($excel){
        ...
        header("Content-Disposition: attachment; filename=deployment_poea_report.xls");
...
?>
<h3>POEA Welfare Monitoring Report</h3>
...
?>
        <table class="table table-bordered" cellspacing="0" style="margin-bottom: 10px;" width="50%" border="1">
            <tbody>
                ...
                <tr>
                    <td width="20%" class="text-left"><strong>Name</strong></td>
