        ...
        <table class="table table-bordered" cellspacing="0" style="margin-bottom: 10px;" width="50%">
            <tbody>
                ...
                <tr>
                    ...
                    <td width="10%" class="text-center"><strong>Referral Date</strong></td>
                    <td width="10%" class="text-center"><strong>Exam Date</strong></td>
                    <td width="10%" class="text-center"><strong>Result</strong></td>
                    <td width="25%"><strong>Clinic</strong></td>
                    <td width="10%" class="text-center"><strong>Expiry Date</strong></td>
                </tr>
                <?php
                    $n = 0;
                ...
                ?>
                        	<tr>
                                ...
                                <td class="text-center"><?php echo dateformat($v_applicant['med_result_exp_date'],1);?></td>
                        	</tr>
                <?php
                            $n++;
                        }
