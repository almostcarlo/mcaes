...
<section class="panel">
    <div class="panel-body">
        ...
        <?php echo form_open(BASE_URL.'settings/save/payment', 'id="frm_facebox_payment"')?>
...
<script>
    function save_this(){
    	...
    	if($('#textName').val() == ''){
    		...
    		$.post(base_url_js+'settings/save/payment', $('#frm_facebox_payment').serialize(), function(data) {
    			if(data){
    				...
    				setTimeout(function(){
    					$.facebox.close();
    					window.location.replace(base_url_js+'settings/search/payment');
    				}, 1000);
    			}else{
