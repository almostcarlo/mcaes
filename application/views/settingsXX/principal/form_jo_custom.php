...
<section class="panel">
    <div class="panel-body">
    	...
    	<?php echo form_open('', 'id="frm_facebox_jo"')?>
        	...
        	<input type="hidden" name="selectMR" id="selectMR" value="0">
        	<input type="hidden" name="textTarget" id="textTarget" value="0">
        	<input type="hidden" name="selectFood" id="selectFood" value="">
        	<input type="hidden" name="textFoodAllowance" id="textFoodAllowance" value="0">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mt-sm">
                    <div class="form-group">
                        <label for="selectFood">Required Qty:</label>
...
<script>
	...
	generateDropdown('company', '#selectCompany', '');
</script>