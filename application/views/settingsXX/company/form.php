		...
		<div class="col-md-6">
			...
			<section class="panel">
                <header class="panel-heading">
					<h3 class="panel-title">Company Manager Form - <?php echo $title;?></h3>
				</header>
				<div class="panel-body">
                    ...
                    <?php echo form_open_multipart('settings/save/company', 'id="frm_add_company"');?>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mt-sm">
                                        <div class="form-group">
                                            <label for="textPrincipalCode">Company Code:</label>
                                            <input type="text" id="textCompanyCode" name="textCompanyCode" autocomplete="off" value="<?php echo $code;?>" <?php echo ($id)?"readonly=\"readonly\"":""?> class="form-control input-sm" />
                                        </div>
                                    </div>
                                    <div class="col-md-8 mt-sm">
                                        <div class="form-group">
                                            <label for="textPrincipalName">Company Name:</label>
                                            <input type="text" id="textCompanyName" name="textCompanyName" value="<?php echo $name;?>" class="form-control input-sm" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <a href="<?php echo BASE_URL;?>settings/company" class="btn btn-block btn-danger">Cancel</a>
                                    </div>
                                </div>
...
<script>
	var current_company_id = '<?php echo $id;?>';
</script>