...
<section class="panel">
    <div class="panel-body">
        ...
        <?php echo form_open(BASE_URL.'settings/save/insurance', 'id="frm_facebox_insurance"')?>
...
<script>
    function save_this(){
    	...
    	if($('#textName').val() == ''){
    		...
    		$.post(base_url_js+'settings/save/insurance', $('#frm_facebox_insurance').serialize(), function(data) {
    			if(data){
    				...
    				setTimeout(function(){
    					$.facebox.close();
    					window.location.replace(base_url_js+'settings/search/insurance');
    				}, 1000);
    			}else{
