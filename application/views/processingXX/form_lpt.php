		...
		<div class="col-md-12">
			...
			<section class="panel">
                <header class="panel-heading">
                	<a href="<?php echo BASE_URL;?>processing/search/lpt" class="btn btn-primary btn-sm pull-right" style="margin-top:-5px;"><i class="fa"></i> LPT List</a>
					<h3 class="panel-title">LPT Form - <?php echo $title;?></h3>
				</header>
				<div class="panel-body">
                    ...
                    <?php echo form_open('processing/save/lpt', 'id="frm_lpt"');?>
                            ...
                            <div>
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <a href="<?php echo BASE_URL;?>/processing/search/lpt" class="btn btn-block btn-danger">Cancel</a>
                                        </div>
                                    </div>
