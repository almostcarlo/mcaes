<section role="main" class="content-body">
	...
	<?php echo form_open('processing/search/pta', 'id="frm_search"');?>
        <div class="input-group mb-md">
            <input type="text" name="textSearch" class="form-control input-lg" placeholder="PTA No" autocomplete="off" value="<?php echo $this->input->post('textSearch');?>">
		...
		<div class="col-md-12">
            ...
            <section class="panel">
                <header class="panel-heading">
                    <a href="<?php echo BASE_URL;?>processing/forms/pta" class="btn btn-primary btn-sm pull-right" style="margin-top:-5px;"><i class="fa fa-plus"></i> Create PTA</a>
                        ...
                        <table class="table table-striped table-condensed table-hover mb-none" id="datatable_lpt">
                            ...
                            <tbody>
                                <?php foreach ($list as $info):?>
                                    <tr>
                                        <td><a href="<?php echo BASE_URL;?>processing/forms/pta/<?php echo $info['id'];?>"><?php echo $info['code'];?></a></td>
                                        ...
                                        <td class="actions text-center">
                                            <a href="<?php echo BASE_URL;?>processing/forms/pta/<?php echo $info['id'];?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="fa fa-pencil"></i></a>
