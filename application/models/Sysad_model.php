<?php
class Sysad_model extends CI_Model {
        ...
        public function add($what){
            ...
            switch($what){
                case 'user':
                    $this->db->set('username', $_POST['textUsername']);
                    $this->db->set('name', $_POST['textName']);
                    $this->db->set('position', $_POST['textPosition']);
                    $this->db->set('is_active', $_POST['selectStat']);
                    if($_POST['textCpassword']!='') $this->db->set('password', 'PASSWORD("'.$_POST['textCpassword'].'")', FALSE);
                    $this->db->set('createdby', $_SESSION['mcaes_user']['username']);
                    $this->db->set('createddt', 'NOW()', FALSE);
                    $this->db->insert('tbl_user');
                    $desc = "New user has been created.";
